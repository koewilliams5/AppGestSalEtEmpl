        ...
        <div class="col-auto">
            <div class="page-utilities">
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    <div class="col-auto">
                        <a class="btn app-btn-secondary" href="{{route('departement.ajouter')}}">
                ...
                <div class="app-card-body">
                    <div class="table-responsive">
                        <table class="table app-table-hover mb-0 text-left">
                            ...
                            @forelse($toutesConfigurations as $config)
                                <tr>
                                    <td class="cell">{{ $config->id }}</td>
                                    <td class="cell">{{ $config->type }}</td>
                                    <td class="cell">{{ $config->valeur }}</td>
                                    <td class="cell">
                                        <a class="btn-sm app-btn-secondary" href="{{ route('departement.modifier', $config->id) }}">Modifier</a>
                                        <a class="btn-sm app-btn-secondary" href="{{ route('departement.supprimer', $config->id) }}">Supprimer</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
