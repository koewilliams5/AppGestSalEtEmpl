...
{{--    Ma page de création d'un nouveau département--}}
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            ...
            <div class="section-intro">Ajouter ici, à travers ce formulaire un nouveau département.</div>
        </div>
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">

                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('departement.ajouterTraitement') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1" name="name" value="{{ old('name') }}" placeholder="Entrer le nom du département ici " required>
