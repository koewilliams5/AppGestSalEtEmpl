                        ...
                        <table class="table app-table-hover mb-0 text-left">
                            ...
                            @forelse($departements as $departement)
                                <tr>
                                    ...
                                    <td class="cell">
                                        <a class="btn-sm app-btn-secondary" href="{{ route('departement.modifier', $departement->id) }}">Modifier</a>
                                        <a class="btn-sm app-btn-secondary" href="{{ route('departement.supprimer', $departement->id) }}">Supprimer</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
